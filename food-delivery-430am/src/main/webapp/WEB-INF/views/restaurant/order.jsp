		...
		<div class="container"
			...
			<div class="row"
				...
				<c:forEach var="orderList" items="${orderList}" varStatus="status" >
					...
					<form:form action="${pageContext.request.contextPath}/restaurant/restaurant_mypage"
								method="post" modelAttribute="order">
						<h5>
						<a href="${pageContext.request.contextPath}/restaurant/order/?id=${orderList.orderId}">Order ID: ${orderList.orderId}</a>
						</h5>
						<p>Ordered Time: ${orderList.orderedTimeStringNew}</p>	
							...
							<form:button id="statusBtn${orderList.orderId}" class="btn btn-primary" >${orderList.orderStatus}</form:button>
					</form:form>
					</div>
				</c:forEach>
			...
			<div class="row"
				...
				<h1>Order Number: ${orderId}</h1>
						...
						<div class="row" >
							<div style="width:100%">
								...
								<c:forEach var="orderedMenuList" items="${orderedMenuList}">
										<tr>
											<td>${orderedMenuList.menuName} ($${orderedMenuList.menuPrice})</td>
								...
								<p>Customer Phone Number : ${customerContact}</p>
					...
					<a href="${pageContext.request.contextPath}/restaurant/restaurant_deleted">Check Deleted Orders</a> 
